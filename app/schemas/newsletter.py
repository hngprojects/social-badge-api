...
class NewsletterSubscribeRequest(BaseModel):
    """
    Data transfer object representing a request to subscribe a new email address
    to the newsletter, validating that the input is a properly formatted email address.
    """
